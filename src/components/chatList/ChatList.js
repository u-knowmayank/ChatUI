      ...
      <div className="main__chatlist">
        ...
        <div className="chatlist__heading">
          ...
          <button className="btn-nobg" onClick={this.toggleChatList}>
            <i style={{ color: "black", fontSize: "15px" }} className={`fa ${isExpanded ? 'fa-chevron-down' : 'fa-chevron-up'}`}></i>
          </button>
        </div>
        {isExpanded && (
        ...
        <div className="demo_Archived">
          ...
          <div class="active-conversations-badge">7</div>
          <button className="btn-nobg">
            <i style={{ color: "black", fontSize: "15px" }} className="fa fa-chevron-down"></i>
          </button>
        </div>
      </div>
    );
